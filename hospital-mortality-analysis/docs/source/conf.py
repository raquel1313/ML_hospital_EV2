...
# hospital_mortality_analysis documentation build
...
from hospital_mortality_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "hospital_mortality_analysis"
author = "Kedro"
...
htmlhelp_basename = "hospital_mortality_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "hospital_mortality_analysis.tex",
        "hospital_mortality_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "hospital_mortality_analysis",
        "Project hospital_mortality_analysis codebase.",
        "Data-Science",
    )
]
